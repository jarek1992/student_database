...
size_t Student::getDay() const {return day_; }
size_t Student::getMonth() const {return month_; }
size_t Student::getYear() const {return year_; }
std::string Student::getAddress() const {return address_; }
std::string Student::getZipCode() const {return zipcode_; } 
std::string Student::getCity() const {return city_; }
std::string Student::getNationality() const {return nationality_; }
...
void Student::setDay(const size_t day) {day_ = day; }
void Student::setMonth(const size_t month) {month_ = month; }
void Student::setYear(const size_t year) {year_ = year; }
void Student::setAddress(const std::string& address) {address_ = address; }
void Student::setZipCode(const std::string& zipcode) {zipcode_ = zipcode; }
void Student::setCity(const std::string& city) {city_ = city; }
void Student::setNationality(const std::string& nationality) {nationality_ = nationality; }
